                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(matchModel.matchInfoModel?.name ?? "방 제목을 지어주세요.",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,letterSpacing: -0.3,color: Colors.white),),

                        Row(
                          children: [
                            Text( matchModel.matchInfoModel?.location ?? '주소를 선택해주세요.' ,style: TextStyle(fontWeight: FontWeight.w600,letterSpacing: -0.3,color: Colors.grey),),
                            SizedBox(width: 3,),
                            Row(
                              children: [
                              ...
                              children: [
                                for (int i = 0; i < matchModel.matchMemberModel.length; i++)...[
                                  if(matchModel.matchMemberModel[i].profileImage != null)
                                    CachedNetworkImage(
                                      imageUrl: matchModel.matchMemberModel[i].profileImage!,
                                      // 이미지 URL
