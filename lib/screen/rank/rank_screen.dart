                              ...
                              child: AppBar(
                                ...
                                bottom: PreferredSize(
                                  ...
                                  child: TabBar(
                                    ...
                                    labelStyle: TextStyle(fontSize: 16,color: Colors.deepPurple.withOpacity(0.7),fontWeight: FontWeight.w900),
                                    unselectedLabelStyle: TextStyle(fontSize: 15,color: Colors.grey.withOpacity(0.7),fontWeight: FontWeight.w900),
                                    tabs: [
                                      Center(child: Text('개인전')),
                                      Center(child: Text('팀전')),
                                    ],
                                  ),
                                ),
                              ),
