...
import 'package:badboys/screen/subScreen/inquiry/inquiry_wrt_screen.dart';
import 'package:badboys/screen/subScreen/inquiry/inquirt_list_item.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          SizedBox(height: 40,),
          CustomAppbar(isNotification: true,isBackButton : false ),
